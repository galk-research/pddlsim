(define (problem strips-grid-y-2)
   ...
   (:objects node0-0 node0-1 node0-2 node0-3 node0-4 node0-5 - location
             node1-0 node1-1 node1-2 node1-3 node1-4 node1-5 node2-0 - location
             node2-1 node2-2 node2-3 node2-4 node2-5 node3-0 node3-1 - location
             node3-2 node3-3 node3-4 node3-5 node4-0 node4-1 node4-2 - location
             node4-3 node4-4 node4-5 node5-0 node5-1 node5-2 node5-3 - location
             node5-4 node5-5 - location
	     triangle diamond square circle - shapes
	     key0 key1 key2 key3 key4 key5 key6 key7 key8 key9 - keys)
   (:init (arm-empty)
          (place node0-0)
          (place node0-1)
          (place node0-2)
