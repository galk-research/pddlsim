(define (problem strips-grid-y-5)
   (:domain grid)
   (:objects node0-0 node0-1 node0-2 node0-3 node0-4 node0-5  - location
             node0-6 node0-7 node0-8 node1-0 node1-1 node1-2 node1-3 - location
             node1-4 node1-5 node1-6 node1-7 node1-8 node2-0 node2-1 - location
             node2-2 node2-3 node2-4 node2-5 node2-6 node2-7 node2-8 - location
             node3-0 node3-1 node3-2 node3-3 node3-4 node3-5 node3-6 - location
             node3-7 node3-8 node4-0 node4-1 node4-2 node4-3 node4-4 - location
             node4-5 node4-6 node4-7 node4-8 node5-0 node5-1 node5-2 - location
             node5-3 node5-4 node5-5 node5-6 node5-7 node5-8 node6-0 - location
             node6-1 node6-2 node6-3 node6-4 node6-5 node6-6 node6-7 - location
             node6-8 node7-0 node7-1 node7-2 node7-3 node7-4 node7-5 - location
             node7-6 node7-7 node7-8 node8-0 node8-1 node8-2 node8-3 - location
             node8-4 node8-5 node8-6 node8-7 node8-8  - location
	     triangle diamond square circle - shapes
	     key0 key1 key2 key3 key4 key5 key6 key7 key8 key9 key10 key11 key12 - keys) 
   (:init (arm-empty)
          (place node0-0)
          (place node0-1)
          (place node0-2)
