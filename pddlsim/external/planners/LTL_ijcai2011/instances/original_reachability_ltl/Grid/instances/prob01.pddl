(define (problem strips-grid-y-1)
   (:domain grid)
   (:objects node0-0 node0-1 node0-2 node0-3 node0-4 node1-0 - location
             node1-1 node1-2 node1-3 node1-4 node2-0 node2-1 node2-2 - location
             node2-3 node2-4 node3-0 node3-1 node3-2 node3-3 node3-4 - location
             node4-0 node4-1 node4-2 node4-3 node4-4 - location 
	     triangle diamond square circle  - shapes
	     key0 key1 key2 key3 key4 key5 key6 key7 key8 - keys)
   (:init (arm-empty)
          (place node0-0)
          (place node0-1)
          (place node0-2)
