...
(:goal <>( (stored goods1 level3) && (stored goods2 level4) && (stored goods3 level4) && (stored goods4 level3) && (stored goods5 level3) && (stored goods6 level5) && (stored goods7 level1) && (stored goods8 level4) && (stored goods9 level1) && (stored goods10 level2) && (stored goods11 level3) && (stored goods12 level3) && (stored goods13 level6) && (stored goods14 level4) && (stored goods15 level3) && (stored goods16 level2) && (stored goods17 level1) && (stored goods18 level1) && (stored goods19 level3) && (stored goods20 level2))))